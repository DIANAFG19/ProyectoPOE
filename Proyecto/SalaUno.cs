...
namespace Proyecto
{
    public partial class SalaUno : Form
    {
        ...
        public static int BuscarA(int id)
        {
            ...
            busqueda.CommandText = @"SELECT * FROM SalaUno";
        ...
        public void ActualizarEstado(int id, string estado)
        {
            ...
            actualizar.CommandText = @"UPDATE SalaUno SET Estado = '" + estado + "' WHERE ID = " + id;
        ...
        private void SalaUno_Load(object sender, EventArgs e)
        {
            algo = true;
        }
        ...
        {
            acumulador += PrecioAsientos();
            tbCompra.Text += Asientos(22);
            float precio = PrecioAsientos();
            if (algo == true)
            {
                Dulceria.id = Dulceria.IDFactura();
                Dulceria.Factura(Dulceria.id, "Asiento #22", precio);
                algo = false;
            }
            else
            {
        ...
        {
            acumulador += PrecioAsientos();
            tbCompra.Text += Asientos(37);
            float precio = PrecioAsientos();
            if (algo == true)
            {
                Dulceria.id = Dulceria.IDFactura();
                Dulceria.Factura(Dulceria.id, "Asiento #37", precio);
                algo = false;
            }
            else
            {
